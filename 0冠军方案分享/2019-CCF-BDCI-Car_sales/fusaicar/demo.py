...
'*****************************************读取初赛和复赛数据*************************************************'
pre_train_sale = pd.read_csv('./pre_data/train_sales_data.csv')
input_data  = pd.read_csv('./data/train_sales_data.csv')
final_data  = pd.read_csv('./data/evaluation_public.csv')
search_data = pd.read_csv('./data/train_search_data.csv')
#将复赛新车型标记出来
...
def pre_rule():
    #初赛60车型的规则方案
    train = pd.read_csv('./pre_data/train_sales_data.csv')
    test = pd.read_csv('./pre_data/evaluation_public.csv')
...
def rule():
    ...
    #初赛60个车型
    pre_sub = pre_rule()
    pre_test = pd.read_csv('./pre_data/evaluation_public.csv')
